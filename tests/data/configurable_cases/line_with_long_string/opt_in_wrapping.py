...
# variable_2 is just a few characters longer than variable_1 but Black somehow decides not to wrap it
...
variable_1 = (
    "very very very very very very very very very very very very very very long string"
)
...
some_class.a.b.some_variable_name = (
    "Once upon a time there is" " a village alongside the river that flows quitely."
)

abc = (
    "this line has two parts; the first string is already long than the line limit of 88 characters;"
